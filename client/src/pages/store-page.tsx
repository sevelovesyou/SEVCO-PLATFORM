  ...
  return (
    <Link href={`/store/products/${product.slug}`}>
      <div
        ...
        className="group border border-border rounded-xl overflow-hidden bg-card hover:shadow-md transition-all duration-200 cursor-pointer flex flex-col"
      >
        <div className="bg-muted/40 flex items-center justify-center h-44">
